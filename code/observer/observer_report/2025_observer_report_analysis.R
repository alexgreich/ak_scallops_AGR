...
## 2025 observer data summary analysis
...
# determine average month of the fishery
  ...
  write_csv("./output/observer/2025/fishery_avg_month.csv")
...
f_fish_stats(catch, c("KNE"), add_ghl = T, 
             path = "./output/observer/2025/fish_stats_KNE.csv")
### KSH
f_fish_stats(catch, c("KSH"), add_ghl = T, 
             path = "./output/observer/2025/fish_stats_KSH.csv")
### KSW
f_fish_stats(catch, c("KSW"), add_ghl = T, 
             path = "./output/observer/2025/fish_stats_KSW.csv")
### Area M
f_fish_stats(catch, c("UB", "WC", "C"), add_ghl = T, 
             path = "./output/observer/2025/fish_stats_M.csv")
### Area O
f_fish_stats(catch, c("O"), add_ghl = T, 
             path = "./output/observer/2025/fish_stats_O.csv")
### Area Q
f_fish_stats(catch, c("Q"), add_ghl = T, 
             path = "./output/observer/2025/fish_stats_Q.csv")
### WKI
f_fish_stats(catch, c("WKI"), add_ghl = T, 
             path = "./output/observer/2025/fish_stats_WKI.csv")
### EKI
f_fish_stats(catch, c("EKI"), add_ghl = T, 
             path = "./output/observer/2025/fish_stats_EKI.csv")
### YAK
f_fish_stats(catch, c("YAK", "D", "D16"), add_ghl = T, 
             path = "./output/observer/2025/fish_stats_YAK.csv")
...
# trends in round_weight and number of scallops
  ...
  mutate(plot = purrr::map2_chr(data, district, function(data, district){
    ...
    ggsave(paste0("./figures/observer/2025/retained_catch_", district, ".png"), 
...
saveRDS(core, "./output/observer/2025/observer_cpue_std.RDS")

# diagnostics 

core <- readRDS("./output/observer/2025/observer_cpue_std.RDS")
...
mapply(function(district, model) {
  ...
  # save plot
  ggsave(paste("./figures/observer/2025/", district, "_observer_cpue_std_diag.png"), plot = qq + rf, height = 5, width = 9, units = "in")
...
ggsave("./figures/observer/2025/observer_cpue_std_yak_effects.png",
...
plot(sm(wki_viz, 1))+
  ...
  l_ciLine() +
  labs(x = "Depth (fa)") -> depth
ggsave("./figures/observer/2025/observer_cpue_std_wki_effects.png",
...
ggsave("./figures/observer/2025/observer_cpue_std_kne_effects.png",
...
plot(pterm(ksh_viz, 4))+
  ...
  l_ciBar(width = 0.5) + l_fitPoints() +
  labs(x = "Dredge Width", y = "f(Dredge Width)") -> dredge_width
ggsave("./figures/observer/2025/observer_cpue_std_ksh_effects.png",
...
ggsave("./figures/observer/2025/observer_cpue_std_ksw_effects.png",
...
#core %>% pull(core_data) %>% .[[4]] -> core_data
  mutate(index = purrr::map2(core_data, model, function(core_data, model) {
    ...
    f_getCPUE_gam(model, loc, yrs)%>%
      ...
      right_join(tibble(year = 1996:2024)) %>% arrange(year)
  })) %>%
